...
public class Supplier extends javax.swing.JPanel {
    ...
    try {
        ...
        String sql = "INSERT INTO Supplier(s_name, tp_number) VALUES ('" + name + "', '" + tp + "')";
        s.executeUpdate(sql);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sql = "SELECT * FROM Supplier WHERE sid = '" + search + "'";
    ...
    try {
       ...
       String sql = "UPDATE Supplier SET s_name=?, tp_number=? WHERE sid=?";
        PreparedStatement ps = con.prepareStatement(sql);
        ps.setString(1, name);
        ps.setString(2, tp);
    ...
    try {
        ...
        PreparedStatement pst = con.prepareStatement(
            "SELECT * FROM Supplier WHERE s_name LIKE ?"
        );
